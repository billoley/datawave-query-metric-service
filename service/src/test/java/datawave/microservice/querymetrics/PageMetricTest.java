...
//        int port = 9043;
        ...
        for (int i = 0; i < numPages; i++) {
            ...
            try {
                ...
                restTemplate.postForEntity(updateUri.toUri(), updateRequestEntity, String.class);

                UriComponents metricUri = UriComponentsBuilder.newInstance().scheme("https").host("localhost").
                                port(port).path(String.format(getMetricsUrl, queryId)).build();
