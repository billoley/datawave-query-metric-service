...
public class ThreadConfigurableLoggerDW extends Logger {
    
    private final Logger log;
    private static ThreadLocal<Map<String,Level>> logToLevelMap = ThreadLocal.withInitial(HashMap::new);
    
    public static ThreadConfigurableLoggerDW getLogger(Class clazz) {
        return new ThreadConfigurableLoggerDW(Logger.getLogger(clazz));
    }
    
    public static ThreadConfigurableLoggerDW getLogger(String name) {
        return new ThreadConfigurableLoggerDW(Logger.getLogger(name));
    }
    
    public static ThreadConfigurableLoggerDW getRootLogger() {
        return new ThreadConfigurableLoggerDW(Logger.getRootLogger());
    }
    
    public ThreadConfigurableLoggerDW(Logger log) {
        super(log.getName());
        this.log = log;
    }
    ...
    private boolean shouldLog(Level requestedLevel) {
        Level allowedLevel = ThreadConfigurableLoggerDW.getThreadLevel(getName());
    ...
    public void setThreadLevel(Level level) {
    ...
    public static void setThreadLevel(String name, Level level) {
    ...
    public static Level getThreadLevel(String name) {
